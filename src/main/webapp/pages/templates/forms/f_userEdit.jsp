        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input class="form-control uData" id="urCOwnership" type="text" name="urOwnership"
                       placeholder="Приватне підприємство" value="${loggedUser.companyDate.ownership}" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input class="form-control uData" id="urCFullName" type="text" name="urFullName"
                       placeholder="Ваша назва" value="${loggedUser.companyDate.fullName}" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input class="form-control uData" id="urCShortName" type="text" name="urShortName"
                       placeholder="ПП ВашаНаз" value='${loggedUser.companyDate.shortName}' required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input class="form-control uData" id="urCCode" type="text" name="urCode"
                       placeholder="01234567" value="${loggedUser.companyDate.code}" required>
            </div>
        </div>
